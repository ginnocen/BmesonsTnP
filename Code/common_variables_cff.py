...
HFHIPhysicsFlagsTrigger = cms.PSet(
   ...
   PAMu3_standard = cms.string("!triggerObjectMatchesByPath('HLT_PAMu3_v*').empty()"),
   PAMu7_standard = cms.string("!triggerObjectMatchesByPath('HLT_PAMu7_v*').empty()"),
   PAMu12_standard = cms.string("!triggerObjectMatchesByPath('HLT_PAMu12_v*').empty()"),  
)
